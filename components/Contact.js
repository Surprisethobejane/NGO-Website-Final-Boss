function Contact() {
  try {
    ...
    return (
      <div className="section-padding bg-gray-50" data-name="contact" data-file="components/Contact.js">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+27662950540" className="text-gray-600 hover:text-purple-600 transition-colors">+27 66 295 0540</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:pmasemolafoundation@gmail.com" className="text-gray-600 hover:text-purple-600 transition-colors">pmasemolafoundation@gmail.com</a>
                  </div>
                </div>
