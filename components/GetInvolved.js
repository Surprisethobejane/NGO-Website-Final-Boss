function GetInvolved() {
  try {
    ...
    return (
      <div className="section-padding bg-white" data-name="get-involved" data-file="components/GetInvolved.js">
        <div className="container-max">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {ways.map((way, index) => (
              <div key={index} className="card text-center group hover:scale-105 transition-transform duration-300 flex flex-col h-full">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed flex-grow">{way.description}</p>
                {way.title === 'Donate' ? (
                  <a 
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <a href="mailto:pmasemolafoundation@gmail.com" className="text-gray-700 hover:text-purple-600 transition-colors">pmasemolafoundation@gmail.com</a>
                  </div>
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">Ext 15, Mamelodi East<br />Pretoria, 0122<br />South Africa</span>
                  </div>
                </div>
              </div>
