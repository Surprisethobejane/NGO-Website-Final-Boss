function About() {
  try {
    ...
    return (
      <div className="section-padding bg-white" data-name="about" data-file="components/About.js">
        <div className="container-max">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8 md:p-12 mb-16">
